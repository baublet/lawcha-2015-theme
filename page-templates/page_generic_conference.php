<?php
/* Template Name: Generic Conference Template */
/**
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= get_template_directory_uri() ?>/chicago-conference.css?2022-05-07-01" media="screen" />
...
<body <?php body_class("chicago-conference"); ?>>
  ...
  <div class="header">
    <div class="inside-wrapper">
      ...
      <div class="conference-info">
        <div class="short-descriptor"><?=get_field("year")?> LAWCHA Conference</div>
        <h2 class="title">
          <a href="/">
            <?=get_field("title")?>
            <?=get_field("subtitle") ? "<span>" . get_field("subtitle") . "</span>" : ""?>
          </a>
        </h2>
        <div class="date"><?=get_field("dates")?></div>
        <?=get_field("location") ? '<div class="location">' . get_field("location") . '</div>' : "" ?>
      </div>
